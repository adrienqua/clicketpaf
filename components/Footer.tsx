...
const Footer = () => {
  return (
    <footer
      className="w-full text-center p-4 bg-amber-100/80 text-amber-800/80 mt-8"
      role="contentinfo"
    >
      <nav
        role="navigation"
      ...
      <nav role="navigation" aria-label="Footer navigation" className="">
        <ul className="flex flex-col md:flex-row justify-center gap-8 mb-4">
          <li>
            <Link
      ...
      <span>&copy; {new Date().getFullYear()} - Clicketpaf</span>
    </footer>
  );
};
