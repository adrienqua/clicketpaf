...
export const metadata: Metadata = {
    title: "Click & Paf - Notre histoire",
    description:
    ...
    openGraph: {
        ...
        type: "website",
        url: "https://clicketpaf.store/histoire",
    },
    twitter: {
        title: "Click & Paf, la mode déjantée !",
        description:
            ...
            <article>
                ...
                <div className="mb-8">
                    ...
                    <p className="mb-4 leading-loose">
                        {`Fondée en 2022 par Léo et Thomas, deux passionnés de mode street, Click & Paf, c’est l’histoire d’une idée simple mais percutante : des vêtements en édition limitée, inspirés par l’actu et les tendances les plus fraîches. Notre concept ? Attraper l’essence du moment et la transformer en pièces qui claquent. Le nom "Click & Paf" dit tout : un clic, et paf, t’as ton look.`}
                    </p>
                    <p className="mb-4 leading-loose">
                    ...
                    <p className="mb-4 leading-loose">
                        {`Aujourd’hui, Click & Paf, c’est bien plus qu’une boutique : c’est un mood, une communauté, un rendez-vous pour tous ceux qui aiment se démarquer avec du sens. Avec notre shop en ligne, on touche la vibe d’une génération connectée, sans perdre notre truc : proposer une mode urbaine, qualitative et toujours en mouvement. Chez Click & Paf, on ne suit pas les tendances, on les crée et on les laisse parler pour toi.`}
                    </p>
                </div>
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">Nos valeurs</h2>
                    <p className="mb-4 leading-loose">
                        {`Chez Click & Paf, on ne se contente pas de créer des vêtements, on imagine des pièces qui ont du sens. Loin des productions de masse, on mise sur la qualité, l’authenticité et surtout, le Made in France. Chaque pièce est fabriquée avec soin, pour que tu portes non seulement un style unique, mais aussi un produit qui soutient l’artisanat local et l’économie de notre pays.`}
                    </p>
                    <p className="mb-4 leading-loose">
                        {`On n'oublie pas notre planète. Chez Click & Paf, on choisit des matières écologiques et durables, parce que la mode doit rimer avec respect de l’environnement. On croit fermement qu’on peut allier style et conscience écologique, sans faire de compromis. Chaque collection est pensée pour réduire notre empreinte tout en restant à la pointe de la tendance.`}
                    </p>
                    <p className="mb-4 leading-loose">
                        {`Mais ce n’est pas tout : une partie de nos bénéfices est reversée à des associations qui font bouger les choses. Parce qu’on veut que notre impact dépasse celui de la mode. En achetant chez Click & Paf, tu fais partie d’un mouvement qui soutient des causes importantes et qui cherche à rendre le monde un peu meilleur, une pièce à la fois.`}
                    </p>
                </div>
            </article>
        </main>
