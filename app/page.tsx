      ...
      <div>
        ...
        <div className="rounded-lg bg-black p-4 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="rounded-lg shadow-lg p-4 bg-black border-2 border-gray-400">
                            ...
                            <p className="mb-2 text-gray-300 leading-loose">
                                {`Click & Paf lance une collection décalée de t-shirts et mugs exclusifs pour célébrer la nomination fictive de François Bayrou comme Premier ministre. 
                        ...
                        <div className="rounded-lg shadow-lg p-4 bg-black border-2 border-gray-400">
                            <Image
                                ...
                                className="pointer-events-none rounded-lg mb-4 w-full h-56"
                            />
                            <h3 className="text-lg font-bold mb-2 text-gray-300">Macron fait du dauphin sur la Seine</h3>
                            <p className="mb-2 text-gray-300 leading-loose">
            ...
            <div className="rounded-lg bg-black p-4 mb-8">
                ...
                <p className="mb-4 leading-loose">
                    <strong className="font-bold">Pourquoi "Click & Paf" ?</strong ><br/>
            ...
            <section className="mb-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center">
                    <div className="bg-black p-4 rounded-lg w-full md:w-1/3 border-2 border-gray-400">
                        <p className="italic">"J'ai acheté un t-shirt de la dernière collection et je suis tellement content de mon achat ! Qualité au top et design unique."</p>
                        <p className="font-semibold mt-2">- Maxime D.</p>
                    </div>
                    <div className="bg-black p-4 rounded-lg w-full md:w-1/3 border-2 border-gray-400">
                        <p className="italic">"La livraison a été rapide, et le service client est super réactif. Je recommande à 100% !"</p>
                        <p className="font-semibold mt-2">- Clara M.</p>
                    </div>
                    <div className="bg-black p-4 rounded-lg w-full md:w-1/3 border-2 border-gray-400">
                        <p className="italic">"Les collections en édition limitée sont vraiment cool, j'ai hâte de voir les prochaines !"</p>
